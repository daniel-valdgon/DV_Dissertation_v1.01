...
\begin{table}[H]
	...
	\label{trends_inf}
	\resizebox{\textwidth}{!}{
		\input{tables/table_programs.tex}
				}		
...
%	\label{mig}
%	\resizebox{11cm}{!}{
%		\input{FISM_annex/tables/9_pop.tex}
%	}		
%	\parbox{\textwidth}{\small 
%		\vspace{2eX}
%		\footnotesize	
...
%\subsubsection{Estimates by deciles (upon request)}
%\begin{table}[H]
%	\centering
%	\small
